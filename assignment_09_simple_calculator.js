...
function divide(a, b) { 
    if (b === 0) return null; // Signal an error
    return a / b; 
}
...
function main() {
    ...
    do {
        ...
        if (choice >= 1 && choice <= 6) {
            ...
            switch (choice) {
                case 1: result = add(num1, num2); operatorSymbol = '+'; break;
                case 2: result = subtract(num1, num2); operatorSymbol = '-'; break;
                case 3: result = multiply(num1, num2); operatorSymbol = '*'; break;
                case 4: 
                ...
                case 5: 
                    ...
                    break;
                case 6: result = exponentiate(num1, num2); operatorSymbol = '**'; break;
            }
